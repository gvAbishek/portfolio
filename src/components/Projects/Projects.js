        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="An ExamCell Inventory Management System Application developed Using MERN Stack. The Application can add,delete,update and display the products in the Inventory. It also allows user to download the list in th eform of CSV."
